...
![](nf-core_eager_logo_outline_drop.png){fig-align="center" width="339"}
...
![](eager2_workflow.png){fig-align="center"}
...
![Pipeline stages and merging steps performed for a single sample with different libraries and different UDG treatments.](merging_files.png){fig-align="center"}
...
![Screenshot of the top section of a MultiQC report](multiqc_report.png){fig-align="center"}
...
![Ancient DNA damage plot as generated by MultiQC](fiveprime_misinc_plot-1.png){fig-align="center" width="1200"}
...
![Overview of the development status of nf-core/eager 3.0 as of October 2023, new functionality marked in purple.](eager3_metromap_complex_developmentupdate_20231020.png){fig-align="center"}

## How can I get help with problems or questions?

![](nf-core.png){width="20"}Check the website for in-depth documentation of [nf-core/eager](https://nf-co.re/eager/2.5.0).

![](github.png){width="20"} Raise your issue on [GitHub](https://github.com/nf-core/eager/).

![](slack.jpg){width="20"}Join the #eager channel on the nf-core [Slack](https://nf-co.re/join#slack).
