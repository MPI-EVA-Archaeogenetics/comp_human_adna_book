...
We decided to follow the recommendation of @Annoni2003.
...
For this tutorial we rely on the data used and published in @Schmid2023. The following, hidden section includes the code to prepare the sample table we need from the supplementary tables published with the paper.
