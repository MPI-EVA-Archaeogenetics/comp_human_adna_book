...
![Overview of the Poseidon framework](popgen_toolbox_schema.png){width="60%"}
...
![The files in a Poseidon package](popgen_toolbox_package_schema.png){width="60%"}
...
![Poseidon needs your data as soon as it is published](recruiting.jpg){width="40%"}
...
![Press the fork button in the top right corner to fork a repository on GitHub](fork.png)
...
![When you pushed to your fork, GitHub will automatically offer to "contribute" to the source repository](pull_request.png)
