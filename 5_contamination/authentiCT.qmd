...
\
![](image-326643966.png){width="476"}

![](image-55127020.png){fig-align="center" width="492"}
...
![](image-1111760292.png){fig-align="center" width="514"}
...
![Excluding the first and last five bases to mask potential overhangs, C-to-Ts are found to particularly common in adjacent positions in many samples, with a significant deviation from the geometric distribution expected from independent events \[Peyrégne and Peter 2020\]](image-1943746165.png){fig-align="center" width="424"}
...
![](image-96701690.png){fig-align="center" width="311"}
...
![](image-970640075.png){fig-align="center"}
...
![](image-1437595134.png){fig-align="center"}
